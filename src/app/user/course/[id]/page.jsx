  ...
  return (
    <div className="bg-secondary ">
      <div className="bg-primary h-44">
        <div className="flex w-10/12 mx-auto  gap-5 items-center h-full">
          <Image
            ...
            height={12}
          />{" "}
          <p className="font-semibold text-white text-xl">Security Awareness - Essentials</p>
        </div>
      </div>
      <div className="w-10/12 mx-auto flex items-center px-5 h-16 rounded-[24px] bg-white shadow -mt-11">
      <progress className="progress w-full progress-flat-secondary" value="20" max="100"></progress>
      </div>
      ...
      <div className='w-[290px] h-[200px] flex justify-between flex-col p-5 bg-white rounded-xl shadow'>
        <h1 className='text-2xl font-semibold text-start'>Objective</h1>
    ...
    {/* pre-assessement */}
    <div className='w-[290px] h-[200px] flex justify-between flex-col p-5 bg-white rounded-xl shadow'>
        <h1 className='text-2xl font-semibold text-start'>Pre-Assessment</h1>
        <div className='btn w-full h-10 bg-primary text-white'>
            <p className='text-xl '>Start</p>
        </div>
    </div>
